      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8 footer-custom-css">
          ...
          <div className="">
            ...
            md:justify-start
          ">
              <FontAwesomeIcon icon={faFeather} className="mr-4" />
              About Me
            </h6>
            <p>
              I'm Zakaria Bin Nizam. Currently studying computer science
              engineering. I love technology. I like to solve problems that make
